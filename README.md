...
5. Follow the on-screen installation instructions. Accept any prompts to install.

6. After installation completes, you can launch ai-eval from your start menu (Windows), Applications folder (macOS), or your Linux application launcher.
...
1. **Load a Model:** Click the “Load Model” button to choose a language model file or connect to an online model if you have API access.

2. **Select Evaluation Task:** Choose from tasks like answering questions, summarizing text, or translating sentences. These tasks test different skills of the model.

3. **Start Evaluation:** Click “Run Evaluation” to test the model on the chosen tasks.

4. **View Results:** After running, ai-eval shows scores and details. The screen will explain what the numbers mean in clear language.
...
3. The software saves a readable report file (PDF or text).
